...
import (
	...
	"github.com/paulagates/cep-weather-tracing/service-b/internal/handlers"
	otelconfig "github.com/paulagates/cep-weather-tracing/service-b/internal/tracing/otel"
...
func main() {
	...
	ctx, span := tracer.Start(ctx, "OperacaoSecundaria")
	...
	go func() {
		log.Println("🚀 Serviço rodando na porta 8081")
